...
export const PageButton = styled.button`
  ...
  gap: 12px;
  padding: 14px 32px;
  background: ${RGBA.slateMuted(0.78)};
  border: none;
  ...
  &:hover {
    background: ${RGBA.slateMuted(0.85)};
    outline: none;
  }
...
export const DiamondIcon = styled.span`
  ...
  width: 20px;
  height: 20px;
  background: ${NEUTRAL.offWhite};
  transform: rotate(45deg);
  box-shadow: 0 0 0 1px ${RGBA.slate(0.3)};
  position: absolute;
  left: 20px;
`;
...
export const ModalContainer = styled.div`
  ...
  /* position: relative; */
  background-color: ${DARK.slateBlue};
...
export const NavItem = styled.button<{ $selected?: boolean }>`
  ...
  &:hover {
    ...
    box-shadow: 0 0 15px ${RGBA.white(0.05)};
  }

  &.selected {
    background: ${RGBA.white(0.08)};
    border: 2px solid ${GOLD.cream};
    color: ${GOLD.creamLight};
    box-shadow: inset 0 0 10px ${RGBA.creamLight(0.1)};
  }
`;
...
export const DiamondCheck = styled.span`
  ...
  transform: rotate(45deg);
  flex-shrink: 0;
  box-shadow: 0 0 0 1px ${RGBA.goldPrimary(0.5)};
`;
...
export const SubmitButton = styled.button`
  padding: 12px 24px;
  background: ${RGBA.goldPrimary(0.4)};
  ...
  &:hover {
    background: ${RGBA.goldPrimary(0.6)};
  }
